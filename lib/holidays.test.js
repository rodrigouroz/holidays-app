...
describe('getHolidays', () => {
  ...
  test('gets the next holidays that match a search term', async () => {
    const mockedResponse = [
      mockedHolidays['AR-1'],
      mockedHolidays['AR-2'],
      mockedHolidays['AR-3'],
  ...
  test('gets the next holidays that match a search term and extends the search to the next year to find a match', async () => {
    const mockedResponseFirstYear = [
      mockedHolidays['AR-1'],
      mockedHolidays['AR-2'],
      mockedHolidays['AR-3'],
