    ...
    <div className={styles.main}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.title}>
          <h1>
            Ask me what you want to know about a holiday
          </h1>
        </div>
        <div className={styles.question}>
          <input type="text" placeholder='e.g. What is the next holiday in Argentina?' value={q} onChange={e => setQ(e.target.value)}></input>
        </div>
        ...
        <div className={styles.footer}>
          <div>
            <p>Made with ❤️ by <a href="https://www.linkedin.com/in/rodrigouroz/">Rodrigo Uroz</a></p>
            <a href="https://github.com/rodrigouroz/holidays-app"><img src='/GitHub-Mark-Light-32px.png' /></a>
          </div>
        </div>
      </div>
